"""
Problem: 
  Given an array of n integers, find an int not in the input. 
  Use a minimal amount of memory.
Constraints:
  Are we working with non-negative ints? Yes
...
Algorithm
  ...
  Say we had only 1 GB of memory or 2^32 bytes.
  This would leave us with 8 billion bits.
