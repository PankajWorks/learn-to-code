...
Constraints:
  Is a naive solution sufficient (ie not stable, not based on a heap)?Yes
...
Algorithm:  
  ...
  Iteratively will be more efficient as it doesn't require the extra space overhead with the recursive calls.
