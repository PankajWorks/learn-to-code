...
Constraints
  Is the input an array of ints? Yes
  Can the input have duplicates? Yes
  Do we know how many times the array was rotated? No
  Was the array originally sorted in increasing or decreasing order? Increasing
  For the output, do we return the index? Yes
